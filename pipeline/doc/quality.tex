...
\begin{tbl}{Leave one characteristic out: each mapping's fit on the held-out portfolios.}
...
\bottomrule\end{tabular}\end{tbl}
\begin{tbl}{Leave one family of characteristics out: each mapping's fit on the held-out portfolios.}
\begin{tabular}{lrrrrr}\toprule
Mapping & $R^2$ & corr. & intercept & slope & RMSE\\\midrule
...
\bottomrule\end{tabular}\end{tbl}
\begin{tbl}{Extreme deciles held out: each mapping's fit on the held-out portfolios.}
\begin{tabular}{lrrrrr}\toprule
Mapping & $R^2$ & corr. & intercept & slope & RMSE\\\midrule
...
; the 560 portfolios of the verified characteristics are
compared.
